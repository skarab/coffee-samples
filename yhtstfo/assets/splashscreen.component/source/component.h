...
namespace splashscreen
{
    ...
    private:
        ...
        graphics::Texture _SplashImage;
        ui::Window* _FullScreenWindow;
        ui::widget::Image* _Image;
        scene::Instance* _StartLevel;
        scene::Instance* _CameraScene;
    };

    COFFEE_RegisterComponent(Component);
}

COFFEE_ExportComponent(splashscreen);
